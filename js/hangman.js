$(document).ready(function() {
  ...
  function titleScreen() {
    $("#gameContent").append(
      '<div id="gameTitle">HANGMAN</div><div id="startButton" class="button">BEGIN</div>'
    );
  ...
  function victoryMessage() {
    ...
    $("#feedback").append(
      "CORRECT!<br><br><div id='replay' class='button'>CONTINUE</div>"
    );
  ...
  function finalPage() {
    $("#gameContent").empty();
    $("#gameContent").append(
      '<div id="finalMessage">You have finished all the words in the game!</div>'
    );
  } //finalpage
});
